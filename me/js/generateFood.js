// Food List of Items
// Credit goes to https://github.com/dariusk/corpora/blob/master/data/foods/menuItems.json
// From: https://github.com/dariusk/corpora
/*
    Why listed here? Had CORS issues with exporting from another webpage so
    i just imported here instead of trying to put it in a separate file.
    I would imagine installing a server is beyond the scope of this assignment
...
function generateFoodEntry() {
    let randomFoodEntry = rawFoodList[Math.floor(rawFoodList.length * Math.random())]
    document.getElementById('food-rando-name').textContent = randomFoodEntry.toLowerCase()
}
document.getElementById('button-generate-food').onclick = function () { generateFoodEntry() }